...
describe("Authentication", () => {
    test('User is able to sign up only once', async () => {
        const username = "kartik" + Math.random(); // kartik0.12331313
    ...
    test('Signup request fails if the username is empty', async () => {
        const username = `kartik-${Math.random()}` // kartik-0.12312313
        const password = "123456"
...
avatarId = avatarResponse?.data?.avatarId;  // Use optional chaining to avoid undefined error
